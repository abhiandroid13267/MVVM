package com.softtech.abhi.samplemvvm.View;
...
import com.softtech.abhi.samplemvvm.R;
import com.softtech.abhi.samplemvvm.ViewModel.LoginViewModel;
import com.softtech.abhi.samplemvvm.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginViewModel.getUser().observe(this, new Observer<LoginUser>() {
            ...
            public void onChanged(@Nullable LoginUser loginUser) {
                ...
                else if (!loginUser.isValidEmailAddress()) {
